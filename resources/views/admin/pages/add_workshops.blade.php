                        ...
                        <div class="span12">
                            ...
                            <div class="widget red">
                                ...
                                <div class="widget-body form">
                                    <!-- BEGIN FORM-->
                                    <form method="Post" action="{{ route('postworkshops') }}" enctype="multipart/form-data"
                                        files="true">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 " name="workshops_title" />
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 " name="reg_link" />
                                       ...
                                       <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="date_details"></textarea>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="organizer"></textarea>
