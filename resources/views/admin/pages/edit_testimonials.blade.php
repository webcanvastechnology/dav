                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                    <form method="Post" action="{{ route('updateTestimonial') }}" enctype="multipart/form-data" files="true" name="edit_form">  
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="educator_name" value="{{$all_testimonial->educator_name}}" />
                                     <input type="hidden" class="span6 " name="educator_id" value="{{$all_testimonial->id}}" />
                            ...
                            <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="default" name="educator_image[]" multiple>
                                         <img src="{{asset('public/educator_image/'.$all_testimonial->educator_image)}}">
                                    </div>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="educator_org" value="{{$all_testimonial->educator_org}}" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="educator_designation" value="{{$all_testimonial->educator_designation}}" />
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="msg_type" id="msg_type" onchange="showDiv(this)">
                           ...
                           <div style='display:none;' id='video_msg'>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="educator_video_msg" value="{{$all_testimonial->educator_video_msg}}" />
...
function showDiv(select){
   if(select.value==1){
    ...
    document.getElementById('video_msg').style.display = "none";
        ...
        <script type="text/javascript">
              document.forms['edit_form'].elements['msg_type'].value=<?php echo $all_testimonial->msg_type; ?>
            </script> 
