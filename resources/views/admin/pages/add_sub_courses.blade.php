                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                    <form method="Post" action="{{ route('postsubcourse') }}" enctype="multipart/form-data" files="true">  
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="form-control" id="exampleFormControlSelect1" name="course_title">
                                     
                                    <option value="For Individual">For Individual</option>
                                     <option value="For Group">For Group</option>
